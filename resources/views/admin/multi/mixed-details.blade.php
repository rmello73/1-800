                    <h2>Multiple-Family Sale Details</h2>
                    
                    <b>Note: Must include units!</b>
						...
						<div class="form-group">
							<label for="year_built">Year Built</label>
								<input type="text" class="form-control" id="year_built"
									value="{{{ $ad->year_built or '' }}}" name="year_built"
						...
						<div class="form-group">
							<label for="tax_year">Tax Year</label>
								<input type="text" class="form-control" id="tax_year"
									value="{{{ $ad->square_unit_space or '' }}}" name="tax_year"
						...
						<div class="form-group">
							<label for="assessment">Assessment</label>
								<input type="text" class="form-control" id="assessment"
									value="{{{ $ad->assessment or '' }}}" name="assessment"
						...
						<div class="form-group">
							<label for="county">County</label>
								<input type="text" class="form-control" id="county"
									value="{{{ $ad->county or '' }}}" name="county"
									placeholder="County">
						</div>
					...
					<div class="form-group">
						<label for="lot_size">Lot Size</label>
							<input type="text" class="form-control" id="lot_size"
								value="{{{ $ad->lot_size or '' }}}" name="lot_size"
						...
						<div class="form-group">
							<label for="water">Water</label>
								<select class="form-control select2NoSearch" name="water"
                                        ...
                                        <option value="Public Avail" {{{ (isset($ad->water) && $ad->water == 'Public Avail') ? "selected=\"selected\"" : "" }}}>Public Avail</option>
                                        <option value="Public Conn" {{{ (isset($ad->water) && $ad->water == 'Public Conn') ? "selected=\"selected\"" : "" }}}>Public Conn</option>
						...
						<div class="form-group">
							<label for="sewer">Sewer</label>
								<select class="form-control select2NoSearch" name="sewer"
                                        ...
                                        <option value="Connected" {{{ (isset($ad->sewer) && $ad->sewer == 'Connected') ? "selected=\"selected\"" : "" }}}>Connected</option>
                                        <option value="In Fee" {{{ (isset($ad->sewer) && $ad->sewer == 'In Fee') ? "selected=\"selected\"" : "" }}}>In Fee</option>
                                        <option value="Municipal" {{{ (isset($ad->sewer) && $ad->sewer == 'Municipal') ? "selected=\"selected\"" : "" }}}>Municipal</option>
                                        ...
                                        <option value="Public Avail" {{{ (isset($ad->sewer) && $ad->sewer == 'Public Avail') ? "selected=\"selected\"" : "" }}}>Public Avail</option>
                                        <option value="Public Conn" {{{ (isset($ad->sewer) && $ad->sewer == 'Public Conn') ? "selected=\"selected\"" : "" }}}>Public Conn</option>
							...
							<label for="heating_type">Heating Type</label>
								<select class="form-control select2NoSearch" name="heating_type"
                                        ...
                                        <option value=""></option>
                                                                ...
                                                                <option value="Central Air" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Central Air') ? "selected=\"selected\"" : "" }}}>Central Air</option>
                                                                <option value="Central Heat" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Central Heat') ? "selected=\"selected\"" : "" }}}>Central Heat</option>
                                                                <option value="Central Stream" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Central Stream') ? "selected=\"selected\"" : "" }}}>Central Stream</option>
                                                                <option value="Common" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Common') ? "selected=\"selected\"" : "" }}}>Common</option>
                                                                <option value="Elec Air Cleaner" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Elec Air Cleaner') ? "selected=\"selected\"" : "" }}}>Elec Air Cleaner</option>
                                                                ...
                                                                <option value="Gas Connected" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Gas Connected') ? "selected=\"selected\"" : "" }}}>Gas Connected</option>
                                                                ...
                                                                <option value="Humidifier" {{{ (isset($ad->heating_type) && $ad->heating_type == 'Humidifier') ? "selected=\"selected\"" : "" }}}>Humidifier</option>
						...
						<div class="form-group">
							<label for="cooling">Cooling</label>
								<select class="form-control select2NoSearch" name="cooling"
                                    ...
                                    <option value="Heat Pump" {{{ (isset($ad->cooling) && $ad->cooling == 'Heat Pump') ? "selected=\"selected\"" : "" }}}>Heat Pump</option>
                                    ...
                                    <option value="Office Only" {{{ (isset($ad->heating_fuel) && $ad->cooling == 'Office Only') ? "selected=\"selected\"" : "" }}}>Office Only</option>
                                    <option value="Partial" {{{ (isset($ad->cooling) && $ad->cooling == 'Partial') ? "selected=\"selected\"" : "" }}}>Partial</option>
						...
						<div class="form-group">
							<label for="hw_fuel">Hot Water Fuel</label>
								<select class="form-control select2NoSearch" name="hw_fuel"
                                        ...
                                        <option value="Indirect" {{{ (isset($ad->hw_fuel) && $ad->hw_fuel == 'Indirect') ? "selected=\"selected\"" : "" }}}>Indirect</option>
                                        <option value="Individual" {{{ (isset($ad->hw_fuel) && $ad->hw_fuel == 'Individual') ? "selected=\"selected\"" : "" }}}>Individual</option>
                                        ...
                                        <option value="Owner Pays" {{{ (isset($ad->hw_fuel) && $ad->hw_fuel == 'Owner Pays') ? "selected=\"selected\"" : "" }}}>Owner Pays</option>
                                        ...
                                        <option value="Tank" {{{ (isset($ad->hw_fuel) && $ad->hw_fuel == 'Tank') ? "selected=\"selected\"" : "" }}}>Tank</option>
                                        <option value="Tankless" {{{ (isset($ad->hw_fuel) && $ad->hw_fuel == 'Tankless') ? "selected=\"selected\"" : "" }}}>Tankless</option>
                                        <option value="Tenant Pays" {{{ (isset($ad->hw_fuel) && $ad->hw_fuel == 'Tenant Pays') ? "selected=\"selected\"" : "" }}}>Tenant Pays</option>
                                                        </select>
						</div>
					...
					<div class="form-group">
						<label for="num_levels">Number of Levels</label>
							<input type="text" class="form-control" id="num_levels"
								value="{{{ $ad->num_levels or '' }}}" name="num_levels"
					...
					<div class="form-group">
						<label for="multi_units">Multi-Family Units</label>
							<input type="text" class="form-control" id="multi_units"
								value="{{{ $ad->multi_units or '' }}}" name="multi_units"
								placeholder="Multi-Family Units">
					</div>

						<div class="form-group">
							<label for="leased_land">Leased Land</label>
								<select class="form-control select2NoSearch" name="leased_land"
                                                                id="leased_land">
                                        <option value=""></option>
                                        <option value="Yes" {{{ (isset($ad->leased_land) && $ad->leased_land == 'Yes') ? "selected=\"selected\"" : "" }}}>Yes</option>
                                        <option value="No" {{{ (isset($ad->leased_land) && $ad->leased_land == 'No') ? "selected=\"selected\"" : "" }}}>No</option>
                                                        </select>
						</div>

						<div class="form-group">
							<label for="pandl">P and L Statement</label>
								<select class="form-control select2NoSearch" name="pandl"
                                                                id="pandl">
                                        <option value=""></option>
                                        <option value="Yes" {{{ (isset($ad->pandl) && $ad->pandl == 'Yes') ? "selected=\"selected\"" : "" }}}>Yes</option>
                                        <option value="No" {{{ (isset($ad->pandl) && $ad->pandl == 'No') ? "selected=\"selected\"" : "" }}}>No</option>
                                                        </select>
						</div>

					<div class="form-group">
						<label for="owner_exp">Owner Annual Expenses</label>
							<input type="text" class="form-control" id="owner_exp"
								value="{{{ $ad->owner_exp or '' }}}" name="owner_exp"
								placeholder="Owner Annual Expenses">
					</div>

					<div class="form-group">
						<label for="owner_inc">Owner Annual Income</label>
							<input type="text" class="form-control" id="owner_inc"
								value="{{{ $ad->owner_inc or '' }}}" name="owner_inc"
								placeholder="Owner Annual Income">
					</div>

                        <legend>Videos</legend>
                        <div class="form-group">
						<label for="ad_title">Property Video</label>
							<input type="text" class="form-control" id="property_video_url"
								value="{{{ $ad->property_video_url or '' }}}" name="property_video_url"
								placeholder="Property Video">
							<p class="help-block">Property Video</p>
					</div>
                    <div class="form-group">
						<label for="ad_title">Neighborhood Video</label>
							<input type="text" class="form-control" id="neighborhood_video_url"
								value="{{{ $ad->neighborhood_video_url or '' }}}" name="neighborhood_video_url"
								placeholder="Neighborhood Video">
							<p class="help-block">Neighborhood Video</p>
					</div>