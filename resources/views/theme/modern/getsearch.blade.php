...
<form id="form" action="{{ route('newsearch', $search) }}" method="POST">
	<div class="inner-form">
    	<div class="input-field first-wrap">
        	<input id="search" type="text" name="search" value="{{ request('search') }}" placeholder="What city are you looking in?" />
       	</div>
...
<script>
    $('#search-form').on('submit', function(e) {
        ...
        window.location('/newsearch/' + search);
    })
</script>
@endsection