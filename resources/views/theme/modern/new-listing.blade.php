                            ...
                            <article class="card js-click-store border" style="width: 18rem;">
                                <div class="parent">
                                    ...
                                    @if($ad->type == "apartment" or $ad->type == "condo" or $ad->type == "loft" or $ad->type == "single-family" or $ad->type == "multi-family"
                                        ...
                                        <p>&nbsp;{{ $ad->street_num }} {{ $ad->street_name }} {{ $ad->street_type }} <br />&nbsp;{{ $ad->new_city }}, {{ $ad->new_state }} {{ $ad->zipcode }}</p>
                                        @if($ad->user->company)
                                        <p style="color:#999999";>&nbsp;{{ $ad->user->company }}</p>
                                        @else
                                        <p style="color:#999999";>&nbsp;1-800RealEstate.com</p>
                                        @endif
                                        <p><b>&nbsp;{{ $ad->comment,0,240 }}</b></p>
                                </div>
                            </article>
				            @endforeach
				        </section>
