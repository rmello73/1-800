...
<div class="container">
    <h1>Real Estate Agents @if($_GET['city']) {{ ucwords($_GET['city']) }} @endif in Rhode Island</h1>
    <div class="ad-box-grid-view">
                @foreach($users as $user)
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="top-rectangle">
        					<div class="ads-thumbnail">
                        		<a href="http://1-800.lenoxproperty.com/agent/{{ $user->id }}">
                                    <p class="colorline">
                                        @if($user->photo)
                                        <img src="http://1-800.lenoxproperty.com/uploads/avatar/{{ $user->photo }}" class="img-profile" />
                                        @else
                                        <img src="http://1-800.lenoxproperty.com/assets/img/default-new.png" class="img-profile" />
                                        @endif
                                    </p>
                        ...
                        <p class="details" align="center">
                            <a href="http://1-800.lenoxproperty.com/agent/{{ $user->id }}" target="_blank" class="button-contact">More Info</a>
                        </p>
                            <p align="center">@if($user->agent_logo) <img src="http://1-800.lenoxproperty.com/uploads/avatar/{{ $user->agent_logo }}" class="img-logo" /></a> @else <img src="http://1-800.lenoxproperty.com/uploads/avatar/1586219346v5ygm-logo.jpg" height="40%" width="40%" />
                                                                                        	@endif</p>
                                </a>
                            </div>
                        </div>
