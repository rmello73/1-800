<div class="search-container mobile-nav">
        {{ Form::open([ 'method'=>'get', 'id' => 'commsalelisting']) }}
 ...
 <label for="type_city">
                ...
                <div class="col-md-9 nopadding">
            				<div class="col-md-2 col-sm-4 col-xs-12 mobile-hide nopadding" >
            				    ...
            				    <p class="bottom-text">All For Sale</p>
                                <p class="type_checkbox"><input type="checkbox" value="commercial_sale" id="type_commercial_sale" name="category[]"></p>
                                <p class="bottom-text">All For Lease</p>
                                <p class="type_checkbox"><input type="checkbox" value="commercial_rental" id="type_rental" name="category[]"></p>
            				</div>
            				<div class="col-md-2 col-sm-6 col-xs-12 mobile-hide nopadding" >
            				    ...
            				    <p class="type_checkbox"><input type="checkbox" value="Commercial" id="type_office" name="sale_type[]"></p>
            				</div>
            				<div class="col-md-2 col-sm-6 col-xs-12 mobile-hide nopadding" >
            				    ...
            				    <p class="type_checkbox"><input type="checkbox" value="industrial" id="type_industrial" name="sale_type[]"></p>
            				</div>
            				<div class="col-md-2 col-sm-6 col-xs-12 mobile-hide nopadding" >
            				    ...
            				    <p class="type_checkbox"><input type="checkbox" value="commercial_sale" id="type_retail" name="category[]"></p>
            				</div>
            				<div class="col-md-2 col-sm-6 col-xs-12 mobile-hide nopadding" >
            				    ...
            				    <p class="type_checkbox"><input type="checkbox" value="commercial_sale" id="type_restaurant" name="category[]"></p>
            				</div>
            				<div class="col-md-2 col-sm-6 col-xs-12 mobile-hide nopadding" >
            				    <div id="commercial" align="center">
