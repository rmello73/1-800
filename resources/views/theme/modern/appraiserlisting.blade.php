                ...
                @foreach($users as $user)
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <div class="top-rectangle">
                            ...
                            <p class="details" align="center">
                                <a href="http://1-800.lenoxproperty.com/professional/{{ $user->id }}" class="btn btn-primary primary-color">More Info</a>
                            </p>
                            &nbsp;
                            <p align="center">@if($user->agent_logo) <img src="http://1-800.lenoxproperty.com/uploads/avatar/{{ $user->agent_logo }}" height="40%" width="40%" /></a> @else <img src="http://1-800.lenoxproperty.com/uploads/logo/1568392819an9ar-logo-small.png" height="40%" width="40%" />
                                                                                        	@endif</p>
                                </a>
                            </div>
                        </div>
